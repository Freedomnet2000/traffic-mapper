...
export default function PendingTable({ onClose }) {
    ...
    return (
        <div className="mt-6 bg-yellow-50 border border-yellow-200 p-4 rounded shadow">
            <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-bold text-yellow-600">🕓 Pending Approvals</h3>
                <button
                    onClick={onClose}
            ...
            <div className="overflow-auto max-h-96">
                <table className="min-w-full text-sm table-auto">
                    <thead className="bg-yellow-100">
                        <tr>
                            <th className="px-3 py-1 text-left">Track ID</th>
                    ...
                    <tbody>
                        {logs.map((log, i) => (
                            <tr key={i} className="border-t border-yellow-100 align-top">
                                <td className="px-3 py-1 font-mono">{log.track_id}</td>
